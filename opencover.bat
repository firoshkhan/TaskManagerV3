...
SET DllContainingTests=%~dp0TaskManager.Test\bin\Debug\TaskManager.Test.dll
...
"%ReportGeneratorExe%" ^
 ...
 -sourcedirs:C:\TaskManagerV3\TaskManager\TaskManager.API
-classfilters:-TaskManager.Properties.*
exit /b %errorlevel%
